...
import { ThreeDCardDemo } from "../components/ui/ProjectCard";
            ...
            <div class="lg:w-1/2 lg:mx-10">
              ...
              <form class="mt-2">
                <div class="-mx-2 md:items-center md:flex">
                  ...
                  <div class="flex-1 px-2 mt-2 md:mt-0">
                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">
                      Email address
                    </label>
                    <input
                ...
                <button class="w-full px-6 py-3 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                  get in touch
                </button>
              </form>
            </div>
